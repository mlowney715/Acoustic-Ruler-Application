...
class SingleChannelWindow(wx.Frame):
    def __init__(self):
        """Constructor"""
        wx.Frame.__init__(self,None, wx.ID_ANY, "Single Channel System",size=(900,550))
...
########System Status GroupBox
        ...
        sysStatusGridSizer = wx.GridBagSizer(2,6)
        sysStatusGridSizer.Add(systemID, pos=(0, 0), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)
        sysStatusGridSizer.Add(sysID_field, pos=(0, 1), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM, border=5)
        sysStatusGridSizer.Add(wiFiSSID, pos=(0, 4), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM, border=5)
        sysStatusGridSizer.Add(wiFiSSID_field, pos=(0, 5), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.RIGHT, border=5)
        sysStatusGridSizer.Add(wiFiStatus, pos=(1,0), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)
        sysStatusGridSizer.Add(wiFiStatus_field, pos=(1,1), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM, border=5)
        
        sysStatusBoxSizer = wx.StaticBox(panel, label="System Status")
        sysStatusBoxSizer.SetFont(font_stdBold)
        boxsizer_status = wx.StaticBoxSizer(sysStatusBoxSizer, wx.HORIZONTAL)
        boxsizer_status.Add(sysStatusGridSizer, flag=wx.LEFT|wx.TOP|wx.RIGHT|wx.BOTTOM, border=10)

########Data Logger GroupBox
        #Labels & buttons & text control box
        pathLabel = wx.StaticText(panel, -1, 'Path:')
        pathTextBox = wx.TextCtrl(panel, wx.ID_ANY, 'C:\Users\username\MyDocuments\AcousticRuler',size=(400,22),style=wx.TE_READONLY|wx.ALIGN_LEFT)
        saveBtn = wx.Button(panel, size=(100,27),label="Save")
        saveAsBtn = wx.Button(panel, size=(100,27),label="Save-As")

        #change fonts
        pathLabel.SetFont(font_std)
        pathTextBox.SetFont(font_std)
        saveBtn.SetFont(font_std)
        saveAsBtn.SetFont(font_std)

        #gridbag sizer for system status
        dataLogGridSizer = wx.GridBagSizer(1,4)
        dataLogGridSizer.Add(pathLabel, pos=(0, 0), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)
        dataLogGridSizer.Add(pathTextBox, pos=(0, 1), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)
        dataLogGridSizer.Add(saveBtn, pos=(0, 2), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)
        dataLogGridSizer.Add(saveAsBtn, pos=(0, 3), flag=wx.TOP|wx.ALIGN_LEFT|wx.BOTTOM|wx.LEFT, border=5)

        dataLogBoxSizer = wx.StaticBox(panel, label="Data Logger")
        boxsizer_dataLogger = wx.StaticBoxSizer(dataLogBoxSizer, wx.HORIZONTAL)
        boxsizer_dataLogger.Add(dataLogGridSizer, flag=wx.LEFT|wx.TOP|wx.RIGHT|wx.BOTTOM, border=10)

        #creating data log file in the my document dir. upon entering 
#-------------------------------------------------------------------------------------------------------------------
        #add the 4 main box sizers to the grid sizer for the single channel form
        ...
        sizer.Add(boxsizer_status, pos=(1, 0),span=(1,2), flag=wx.EXPAND|wx.LEFT|wx.RIGHT , border=10)
        sizer.Add(boxsizer_dataLogger, pos=(2, 0),span=(1,2), flag=wx.EXPAND|wx.LEFT|wx.RIGHT , border=10)
